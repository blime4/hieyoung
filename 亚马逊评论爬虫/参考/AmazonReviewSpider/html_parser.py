...
class HtmlParser(object):
    ...
    def get_reviews_info(self, content):
        ...
        review_body_list = html.xpath('//div[@class="a-row review-data"]/span[@data-hook="review-body"]/text()')
...
if __name__ == '__main__':
    ...
    print(HtmlParser("https://www.amazon.co.uk").parse_main_page_reviews_url(content2))
